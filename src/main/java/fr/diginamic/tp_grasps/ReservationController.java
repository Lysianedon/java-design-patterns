...
import fr.diginamic.tp_grasps.services.ReservationFactory;
...
public class ReservationController {
	...
	public Reservation creerReservation(Params params) {
		...
		Reservation reservation = ReservationFactory.creerReservation(dateReservation, type, nbPlaces, client);
		return reservation;
